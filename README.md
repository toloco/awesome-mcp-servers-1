...
- <img src="https://cdn.simpleicons.org/whatsapp/25D366" height="14"/> [Whasapo](https://github.com/toloco/whasapo) - WhatsApp MCP server written in Go. Send and read messages, list chats, and search contacts from any MCP-compatible client. Single binary, no runtime dependencies, local-only session storage.
